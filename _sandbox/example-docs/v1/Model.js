...
class Model extends SequelizeModel {
    ...
    /**
     * add format property to any attribute.
     * format is an OPTIONAL validation key that uses ajv-formats.
     * please see documentation for more information. https://github.com/ajv-validator/ajv-formats
     * 
     * For more information on sequelize attributes & options
     * please visit https://sequelize.org/docs/v6/core-concepts/model-basics/#column-options
     */
    static attributes(){
        return {
            ...
            label: {
                ...
                allowNull: false,
                // format: '', OPTIONAL validation key that uses AJV formats.
            },
            prop: {
                type: DataTypes.STRING,
                allowNull: true,
    ...
    static schema({exclude=[]}){
        ...
        for(let [attribute,props] of Object.entries(attributes)){
            ...
            if(props.format) schema[attribute].format = props.format;
